...
internal class SeriesRepositoryImpl(private val api: SeriesApi) : SeriesRepository {
    ...
    override suspend fun getPopularSeries(page: Int, language: String): NetworkResponse<PopularResponse> =
        api.getPopularSeries(languageId = language, page = page)

    override suspend fun getTopRatedSeries(page: Int, language: String): NetworkResponse<TopRatedResponse> =
